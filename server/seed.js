...
async function main() {
	...
	const categories = [
		...
		},
		{
			name: 'Hỗ trợ',
			slug: 'ho-tro',
			description: 'Chương trình hỗ trợ người khiếm thị',
			color: '#EF4444'
		},
...
Liên hệ hotline: **0123 456 789** để đăng ký tham gia.`,
			excerpt:
				'Chương trình đào tạo CNTT 6 tháng hoàn toàn miễn phí dành cho người khiếm thị tại Hải Dương',
			status: 'PUBLISHED',
...
Trung tâm cam kết hỗ trợ 100% học viên tìm được việc làm phù hợp sau khi hoàn thành khóa học.`,
			excerpt:
				'Khám phá các cơ hội việc làm hấp dẫn trong ngành công nghệ dành cho người khiếm thị',
			status: 'PUBLISHED',
