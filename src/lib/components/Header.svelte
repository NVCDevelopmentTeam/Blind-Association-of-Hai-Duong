...
<header
	class="bg-white dark:bg-gray-900 shadow-lg sticky top-0 z-40"
			...
			<div class="flex justify-between items-center text-sm">
				...
				<div class="flex items-center space-x-4">
					...
					<div class="relative group">
						...
						<div
							class="absolute right-0 mt-2 w-32 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200"
						>
							<button
			...
			<div class="flex items-center">
				<a href="/" class="flex items-center space-x-3">
					...
					<div class="hidden sm:block">
						<h1 class="text-xl font-bold text-gray-900 dark:text-white">TTPHCN Hải Dương</h1>
						<p class="text-sm text-gray-600 dark:text-gray-400">Trung tâm Phục hồi chức năng</p>
					</div>
				</a>
			</div>
			...
			<nav class="px-4 py-4 space-y-2" aria-label="Điều hướng di động">
				{#each navigation as item}
					<a
						...
						class="flex items-center space-x-3 px-3 py-2 rounded-md text-base font-medium transition-colors {isActive(
							item.href
						)
							? 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-900/20'
							: 'text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-50 dark:hover:bg-gray-800'}"
