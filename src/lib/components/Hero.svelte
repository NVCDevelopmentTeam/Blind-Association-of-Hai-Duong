	...
	const slides = [
		{
			...
			description:
				'Chúng tôi cam kết mang đến những dịch vụ phục hồi chức năng và đào tạo nghề chất lượng cao cho người khiếm thị',
		...
		},
		{
			...
			description:
				'Các khóa đào tạo CNTT, massage, thủ công mỹ nghệ được thiết kế phù hợp với người khiếm thị',
			image: '/placeholder.svg?height=600&width=1200',
			cta: {
...
<section class="relative bg-gray-900 overflow-hidden" aria-label="Hero banner">
	...
	<div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
		<div class="text-center lg:text-left lg:max-w-2xl">
			{#each slides as slide, index}
				<div
					class="transition-all duration-500 {index === currentSlide
		...
		<div class="flex space-x-2">
			{#each slides as _, index}
				<button
					...
					class="w-3 h-3 rounded-full transition-colors {index === currentSlide
						? 'bg-white'
