...
{#if isSupported}
  <div class="relative">
    ...
    {#if showControls}
      <div class="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50 p-4">
        ...
        <!-- Speed Control -->
        <div class="mb-4">
          <label for="rate-control" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            Tốc độ: {rate}x
          </label>
          <input 
            id="rate-control"
        ...
        <!-- Pitch Control -->
        <div class="mb-4">
          <label for="pitch-control" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            Cao độ: {pitch}
          </label>
          <input 
            id="pitch-control"
