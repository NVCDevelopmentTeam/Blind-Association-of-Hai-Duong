    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div class="lg:col-span-1">
        ...
        <p class="text-gray-400 text-sm mb-4 leading-relaxed">
          {settings?.site_description || 'Nơi hỗ trợ, đào tạo và tạo việc làm cho người khiếm thị tại Hải Dương'}
        </p>
        ...
        <div class="space-y-2 text-sm">
          ...
          <div class="flex items-center">
            ...
            <a href="tel:{settings?.contact_phone || '+84123456789'}" class="text-gray-400 hover:text-white transition-colors">
              {settings?.contact_phone || '+84 123 456 789'}
            </a>
          </div>
          <div class="flex items-center">
            <i class="fas fa-envelope text-blue-400 mr-3" aria-hidden="true"></i>
            <a href="mailto:{settings?.contact_email || 'info@ttphcn-haiduong.vn'}" class="text-gray-400 hover:text-white transition-colors">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="text-gray-400 text-sm mb-4 md:mb-0">
          <p>
            © {currentYear} {settings?.site_name || 'Trung tâm Phục hồi chức năng Hải Dương'}. 
      ...
      <div class="mt-4 pt-4 border-t border-gray-800 text-center">
        <p class="text-gray-400 text-xs">
          Website này được thiết kế tuân thủ các tiêu chuẩn truy cập web WCAG 2.1 AA để đảm bảo khả năng tiếp cận tốt nhất cho người khiếm thị.
