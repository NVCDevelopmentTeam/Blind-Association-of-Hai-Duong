...
<aside class="space-y-8" aria-label="Tiện ích hỗ trợ">
		...
		<div class="space-y-3">
			...
			>
				...
				<div>
					...
					<div class="text-xs text-gray-500 dark:text-gray-400">Tìm kiếm thông tin chi tiết</div>
				</div>
			</a>
			...
			>
				...
				<div>
					...
					<div class="text-xs text-gray-500 dark:text-gray-400">Xem vị trí và đường đi</div>
				</div>
			</a>
			...
			>
				...
				<div>
					...
					<div class="text-xs text-gray-500 dark:text-gray-400">Brochure và hướng dẫn</div>
				</div>
			</a>
			...
			>
				...
				<div>
					...
					<div class="text-xs text-gray-500 dark:text-gray-400">Chat với chuyên viên</div>
				</div>
			</a>
		</div>
	</div>
	...
	<!-- Emergency Contact -->
	<div
		class="bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800 p-6"
	>
		...
		<div class="space-y-3 text-sm">
			<div class="flex items-center">
				...
				<a
					...
					class="text-red-700 dark:text-red-300 hover:underline font-medium"
				>
					+84 123 456 789
				</a>
			</div>
