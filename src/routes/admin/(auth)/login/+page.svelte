<script>
	...
	function validateForm() {
		...
		if (!form.email) {
			...
			errors.email = 'Email không hợp lệ. Vui lòng nhập đúng định dạng email có chứa ký tự @ (ví dụ: user@example.com)';
		}
...
<svelte:head>
	...
	<meta name="description" content="Đăng nhập vào hệ thống quản trị website Trung tâm Phục hồi chức năng và Giáo dục nghề nghiệp cho Người mù Hải Dương" />
...
<div class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
	<div class="max-w-md w-full space-y-8">
		...
		<!-- Login Form -->
		<form class="mt-8 space-y-6 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg" onsubmit={handleSubmit}>
			{#if error}
				...
				<div>
					...
					<div class="relative">
						...
						<input
							...
							class="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white placeholder-gray-400 {validationErrors.email ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''}"
				...
				<div>
					...
					<div class="relative">
						...
						<input
							...
							class="block w-full pl-10 pr-12 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white placeholder-gray-400 {validationErrors.password ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''}"
						...
						>
							<i class="fas {showPassword ? 'fa-eye-slash' : 'fa-eye'} text-gray-400 hover:text-gray-600" aria-hidden="true"></i>
						</button>
					</div>
