...
<svelte:head>
	...
	<meta
		name="description"
		content="Trung tâm Phục hồi chức năng và Giáo dục nghề nghiệp cho Người mù Hải Dương - Nơi hỗ trợ, đào tạo và tạo việc làm cho người khiếm thị"
	/>
	<meta
		name="keywords"
		content="phục hồi chức năng, người khiếm thị, đào tạo nghề, việc làm, Hải Dương"
	/>
</svelte:head>
